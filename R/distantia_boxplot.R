...
#' @description
#'
#' This function generates a visual summary of the dissimilarity or importance scores generated by the functions [distantia()] and [momentum()].
#'
#' \itemize{
...
#'   \item [momentum()] data frame: plots the importance (contribution to similarity/dissimilarity) of each variable across all time series, facilitating the identification of variables making time series more or less similar.
#'
#' }
#'
...
distantia_boxplot <- function(
  ...
  if(!(df_type %in% types)){
    stop("distantia::distantia_boxplot(): argument 'df' must be the output of distantia::distantia() or distantia::momentum()", call. = FALSE)
  }
