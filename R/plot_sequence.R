...
#' @param color (optional, character vector) Vector of colors for the sequence curves. If not provided, defaults to the "Zissou 1" color scale provided by the function [grDevices::hcl.colors()]. Default: NULL
