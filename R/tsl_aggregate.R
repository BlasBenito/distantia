...
#' }
#' @param f (required, function) name of a standard or user-defined function to aggregate numeric vectors. Typical examples are `mean`, `max`,`min`, `median`, and `sd`, but others such as [f_slope()] are available as well. Default: `mean`.
