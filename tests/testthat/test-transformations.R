...
test_that("`f_slope()` works", {
  expect_equal(f_slope(x = cumsum(runif(10))), )
  expect_equal(f_slope(x = 10), )
  expect_equal(f_slope(x = numeric(0)), )
})
