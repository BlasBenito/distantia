...
You can download the Rmarkdown notebook used to render this article [here](https://github.com/BlasBenito/distantia/blob/main/vignettes/articles/mapping_dissimilarity.Rmd). To download the file, use the button *Download raw file* on the upper-right hand of the `Code` panel.
