...
The function `distantia_spatial_network()` transforms the result of `distantia()` to a spatial file with edges connecting time series locations. The result can be interpreted as a *dissimilarity network*. 
