...
However, **DTW is highly sensitive to differences in data magnitudes**. As a result, data that is not properly scaled may distort the warping path, leading to spurious alignments.
...
The "twoway" plot provided by `dtw` shows the alignment as a line graph, with sample matches represented as dotted lines and two vertical lines marking the local optima.
