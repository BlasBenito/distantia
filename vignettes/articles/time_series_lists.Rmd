...
```
We can compute the stats of these linear trends to identify the cities with steeper temperature changes.
...
The code below computes the linear trend stats of the detrended data. A range 
