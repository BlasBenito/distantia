...
The package `distantia` implements a restricted permutation analysis to help assess the significance of dissimilarity scores. It accepts different setups to support different data assumptions. 
