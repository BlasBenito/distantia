...
When comparing multivariate time series, certain variables contribute more to similarity or dissimilarity. The `distantia_importance()` function uses a leave-one-out algorithm to quantify each variable's contribution to the overal dissimilarity between two time series.
